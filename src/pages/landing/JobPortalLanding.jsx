                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        ...
                        boxShadow: `0 8px 20px ${colors.green}40`,
                      },
              ...
              <Box sx={{ position: "relative", maxWidth: "500px" }}>
                ...
                <Paper
                  sx={{
                    ...
                    borderRadius: 3,
                    p: 2,
                    boxShadow: `0 15px 30px ${colors.green}40`,
                ...
                <Paper
                  sx={{
                    ...
                    bottom: "15%",
                    left: "0%",
                    background: `linear-gradient(135deg, ${colors.saffron}, ${colors.darkSaffron})`,
                    color: colors.white,
                    borderRadius: 3,
                    p: 2,
                    boxShadow: `0 15px 30px ${colors.saffron}40`,
                ...
                <Paper
                  sx={{
                    ...
                    top: "50%",
                    left: "10%",
                    background: `linear-gradient(135deg, ${colors.blue}, #1e3a8a)`,
                    color: colors.white,
                    borderRadius: 3,
                    p: 2,
                    boxShadow: `0 15px 30px ${colors.blue}40`,
                  ...
                  sx={{
                    ...
                    backgroundColor:
                      activeDepartment === department.id
                        ...
                        : "transparent",
                    color:
                      activeDepartment === department.id ? colors.white : colors.green,
                    "&:hover": {
                      backgroundColor:
                        activeDepartment === department.id
                          ? colors.darkGreen
                      ...
                      borderColor:
                        activeDepartment === department.id
                          ...
                          : colors.darkSaffron,
                      transform: "translateY(-2px)",
                      boxShadow: `0 4px 12px ${colors.green}20`,
                    },
                    transition: "all 0.3s ease",
                  }}
                >
...
width: "100%",
                    ...
                    "&:hover": {
                      ...
                      boxShadow: `0 20px 25px -5px ${colors.saffron}30`,
                ...
                >
                  <CardContent sx={{ p: 3 }}>
                    ...
                    <Box sx={{ mb: 3 }}>
                      ...
                      >
                        <Place sx={{ fontSize: 18, color: colors.blue }} />
                        <Typography
                          variant="body2"
                          sx={{ color: colors.blue, fontWeight: 500 }}
                        >
                          {job.location}
                        </Typography>
                      </Box>
                      ...
                      >
                        <AttachMoney sx={{ fontSize: 18, color: colors.blue }} />
                        <Typography
                          variant="body2"
            ...
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  ...
                  color: colors.white,
                  transform: "translateY(-2px)",
                  boxShadow: `0 8px 20px ${colors.green}30`,
                },
                transition: "all 0.3s ease",
              }}
            >
      ...
      <Box sx={{ py: 8, bgcolor: colors.white, overflow: "hidden" }}>
        <Container maxWidth="lg">
          {/* Section Header */}
          <Box sx={{ textAlign: "center", mb: 6 }}>
            <Typography
              ...
              {[
                ...
                <Box
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      transform: "translateY(-4px)",
                      boxShadow: `0 20px 25px -5px ${category.color}30`,
                    },
                  }}
                >
            ...
            {[1, 2, 3, 4, 5, 6].map((dot) => (
              <Box
                ...
                sx={{
                  ...
                  height: 8,
                  borderRadius: "50%",
                  bgcolor: dot === 1 ? colors.green : colors.saffron,
                  cursor: "pointer",
                  transition: "all 0.3s ease",
                  "&:hover": {
                    bgcolor: colors.green,
              ...
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    ...
                    color: colors.white,
                    transform: "translateY(-2px)",
                    boxShadow: `0 8px 20px ${colors.saffron}40`,
                  },
                  transition: "all 0.3s ease",
                }}
              >
