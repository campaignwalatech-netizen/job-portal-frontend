...
<p align="left">
	A modern and fully responsive Job Portal frontend built using React + Vite.  
...
- [x] **Task 1: Landing Pages**  
  Home, Employer, and Employee landing pages — **Completed**

- [ ] **Task 2: Employer Panel**  
  Dashboard, Post Job (Step 1–5), Database Search, Billing, Credits, Notifications  
  **In Progress (Assigned: Afreeda Asad)**

- [ ] **Task 3: Employee Panel**  
  Employee Dashboard, Job Search UI, Profile Settings  
  **Not Started Yet**
